...
![Поток данных при обработке звонка](diagrams/diagram_3.png)
...
![Компоненты ядра анализа](diagrams/diagram_4.png)
...
![Система оповещений](diagrams/diagram_5.png)
...
![Структура базы данных](diagrams/diagram_6.png)

*Отображает схему БД: таблицы, связи, ключевые сущности для хранения событий, аудиофрагментов и настроек.*
...
*Отображает доступные эндпоинты API Gateway и их взаимодействие с внешними системами (колл‑центр, BI, супервизор).*

#### 7. Развёртывание (Docker Compose)


![Развёртывание](diagrams/diagram_8.png)


*Изображает компоненты, развёрнутые через Docker Compose: сервисы, БД (PostgreSQL), кэш (Redis), инструменты мониторинга (Prometheus, Grafana).*


#### 8. Мониторинг и оповещения о сбоях

![Мониторинг и оповещения о сбоях](diagrams/diagram_10.png)
