...
Ниже представлены изображения основных диаграмм системы (из каталога `diagrams/`):


#### 1. Архитектура системы выявления негативных ситуаций

![Архитектура системы](diagrams/diagram_1.png)

*Показывает общую структуру системы, взаимодействие основных компонентов и потоков данных.*

#### 2. Поток данных: обработка звонка и детекция негативных ситуаций

![Поток данных](diagrams/diagram_4.png)

*Описывает последовательность обработки аудиопотока от колл‑центра до детекции негативных ситуаций.*


#### 3. Ядро анализа: компоненты и взаимодействие

![Ядро анализа](diagrams/diagram_5.png)

*Детализирует внутреннюю структуру модуля анализа: обработку аудио, транскрибацию, анализ эмоций и агрегацию сигналов.*

#### 4. Система оповещений: каналы и приоритеты

![Система оповещений](diagrams/diagram_6.png)

*Демонстрирует маршрутизацию оповещений в зависимости от приоритета события (Telegram, Slack, Email, Битрикс24, UI).*

#### 5. API Endpoints системы

![API Endpoints](diagrams/diagram_7.png)

*Отображает доступные эндпоинты API Gateway и их взаимодействие с внешними системами.*


#### 6. Инфраструктура развёртывания

![Инфраструктура развёртывания](diagrams/diagram_8.png)

*Изображает компоненты, развёрнутые на Docker Host: сервисы, БД, инструменты мониторинга.*

#### 7. Мониторинг системы и оповещения о сбоях

![Мониторинг и оповещения](diagrams/diagram_10.png)

*Описывает систему мониторинга (Prometheus, Alert Manager) и каналы оповещения о сбоях (Telegram, Email).*
